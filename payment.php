...
<html lang="en">
 <head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="assets/img/image2.png">
    <!-- CSS 
    ============================================ -->
        ...
        <div class="header-wrapper rn-popup-mobile-menu m--0 row align-items-center">
            ...
            <div class="col-lg-2 col-6">
                <div class="header-left">
                    <div class="logo">
                        <a href="index.html">
                            <h5><img src="assets/img/image2.png" alt="logo" height="112px" width="112px"></h5>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="header-center">
                    <nav id="sideNav" class="mainmenu-nav navbar-example2 d-none d-xl-block onepagenav">
                        ...
                        <ul class="primary-menu nav nav-pills">
                            <li class="phone">Phone: <a href="tel:8542057751">+91-8542057751</a></li>
                    ...
                    <div class="header-right">
                        <a class="rn-btn" target="_blank" href=""><span>PAYMENT NOW</span></a>
            ...
            <div class="row mt--50 mt_md--40 mt_sm--40 mt-contact-sm">
                <div class="col-lg-12">
                    <div class="contact-about-area">
                        <div class="thumbnail">
                            <!-- <h6><img src="photo1.jpeg" alt="Avatar" style="width: 380px;" height="455px;" ></h6> -->
                        </div>
                        ...
                        <div class="social-area">
                            ...
                            <div class="social-icone">
                                ...
                                <a href="https://www.linkedin.com"><i data-feather="linkedin"></i></a>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="portfolio-popup-thumbnail">
                                <div class="image">
                                    <img class="w-100" src="logo.jpg" alt="slide">
                                </div>
                            </div>
                        </div>
